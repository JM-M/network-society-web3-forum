  ...
  return (
    <>
      <div className='absolute top-[0px] right-[0px] py-10 z-50 w-[165px]'>
        ...
        >
          <div
            className='text-gray-900 font-medium hover:bg-gray-50 cursor-pointer rounded py-1.5 px-2'
                        ...
                        {posts.map((post, key) => {
                          if (post.content.master) {
                            return (
                              <Link
                                key={post.stream_id}
                                className='text-gray-500 font-medium hover:bg-gray-50 cursor-pointer rounded py-1.5 px-2'
              ...
              <div className='flex h-full flex-col overflow-y-scroll bg-white shadow-xl'>
                <div className='bg-brand py-6 px-4 sm:px-6'>
                  <div className='flex items-center justify-between'>
                    <h2
                      className='text-3xl font-medium text-white deacon'
                      id='slide-over-title'
                    >
                      Community Chat
                    </h2>
